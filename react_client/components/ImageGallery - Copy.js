  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity 
          style = {styles.backwardArrowCube}
          onPress = {this.goBackward.bind(this)}
          >
          <Image style = {styles.backArrow} source = {require('./../assets/arrow.png')}></Image>
        </TouchableOpacity>
        <View style = {styles.gallery}>
          {currentTile}
        </View>
        <TouchableOpacity 
          style = {styles.forwardArrowCube}
          onPress = {this.goForward.bind(this)}
          >
          <Image style = {styles.forArrow} source = {require('./../assets/arrow.png')}></Image>
        </TouchableOpacity>
      </View>
    )
  };
